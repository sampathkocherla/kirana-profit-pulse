...
const lowStockItems = [
  ...
  { name: "Basmati Rice", currentStock: 45, recommended: 120, urgency: "Low", daysLeft: 20 },
];
...
const restockSuggestions = [
  ...
  { name: "Cardamom", demandTrend: "Stable", suggestedQuantity: 20, cost: 5000, expectedProfit: 2000 },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Stock Suggestions</h1>
        <p className="text-gray-600">Smart inventory management recommendations</p>
      </div>
            ...
            {lowStockItems.map((item, index) => (
              <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                ...
                <div className="flex items-center gap-2">
                  <Switch />
                  <Button size="sm" className="bg-business-primary hover:bg-business-secondary">
                    Reorder Now
                  </Button>
                </div>
              </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <RefreshCw className="w-5 h-5 text-business-primary" />
            ...
            {restockSuggestions.map((item, index) => (
              <div key={index} className="p-4 border rounded-lg bg-blue-50 border-blue-200">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-semibold text-gray-900">{item.name}</h4>
                  <Badge className={getDemandColor(item.demandTrend)}>
                    {item.demandTrend}
                  </Badge>
                </div>
